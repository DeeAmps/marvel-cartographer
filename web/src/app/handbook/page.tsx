...
export const metadata = {
  title: "Handbook",
  description:
    "The Official Marvel Cartographer Handbook — characters, teams, artifacts, locations, species, and editorial concepts with era-by-era tracking and retcon histories.",
};
