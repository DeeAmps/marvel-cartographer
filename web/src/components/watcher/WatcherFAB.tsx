...
import type { WatcherPageContext, WatcherPageType } from "@/lib/watcher-context";
...
export default function WatcherFAB() {
  ...
  // Hide on /watcher page (avoid double UI) and /login
  if (pathname === "/watcher" || pathname === "/login" || pathname === "/signup") {
    return null;
  }
