...
export default function MediaContentCard({ content }: { content: MCUContent }) {
  const { basePath } = usePublisher();
  ...
  return (
    <Link href={`${basePath}/media/${content.slug}`} className="block group">
      <div
